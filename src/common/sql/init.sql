...
insert into goods_class(class_name) values('箱包');
insert into goods_class(class_name) values('女鞋');
insert into goods_class(class_name) values('美妆');
insert into goods_class(class_name) values('饰品');
insert into goods_class(class_name) values('洗护');
insert into goods_class(class_name) values('百货');
insert into goods_class(class_name) values('运动');
insert into goods_class(class_name) values('手机');
insert into goods_class(class_name) values('男装');
insert into goods_class(class_name) values('数码');
insert into goods_class(class_name) values('食品');
insert into goods_class(class_name) values('书籍');
insert into goods_class(class_name) values('家电');
